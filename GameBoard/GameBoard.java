public class GameBoard {
  ...
  public void update(Move curMov, char myColor){
    ...
    if(curMov.cLX() != -1){
        replace(curMov.currentLocation(), 'e');
        //gameState[curMov.currentLocation.x()][curMov.currentLocation.y()] = 'e';
    }

    if(curMov.fLX() != -1){
        replace(curMov.futureLocation(), myColor);
        //gameState[curMov.currentLocation.x()][curMov.currentLocation.y()] = myColor;
    }
